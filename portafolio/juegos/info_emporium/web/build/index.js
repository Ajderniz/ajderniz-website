...
Module['FS_createPath']("/assets/img", "face", true, true);
Module['FS_createPath']("/assets", "sound", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/README.md", "start": 0, "end": 163}, {"filename": "/assets/fonts/DOS-V_re_ANK16.ttf", "start": 163, "end": 30131}, {"filename": "/assets/fonts/DOS-V_re_ANK30.ttf", "start": 30131, "end": 69183}, {"filename": "/assets/img/bg.png", "start": 69183, "end": 85372}, {"filename": "/assets/img/face/angry.png", "start": 85372, "end": 88400}, {"filename": "/assets/img/face/annoyed.png", "start": 88400, "end": 91265}, {"filename": "/assets/img/face/attentive.png", "start": 91265, "end": 94025}, {"filename": "/assets/img/face/ecstatic.png", "start": 94025, "end": 97302}, {"filename": "/assets/img/face/flustered.png", "start": 97302, "end": 100260}, {"filename": "/assets/img/face/happy.png", "start": 100260, "end": 103226}, {"filename": "/assets/img/face/indifferent.png", "start": 103226, "end": 105921}, {"filename": "/assets/img/face/neutral.png", "start": 105921, "end": 108673}, {"filename": "/assets/img/face/solemn.png", "start": 108673, "end": 111405}, {"filename": "/assets/img/fg.png", "start": 111405, "end": 114258}, {"filename": "/assets/sound/gnossienne1.ogg", "start": 114258, "end": 1659783, "audio": 1}, {"filename": "/assets/sound/sound.wav", "start": 1659783, "end": 1665491, "audio": 1}], "remote_package_size": 1665491});

  })();

// end include: /tmp/tmpytxibmmt.js
// include: /tmp/tmptykdc2zq.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmptykdc2zq.js
// include: /tmp/tmpq9vx2vm5.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpq9vx2vm5.js
...
var ASM_CONSTS = {
  143608: () => { if (document.fullscreenElement) return 1; },  
 143654: () => { return document.getElementById('canvas').width; },  
 143706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 143774: () => { document.exitFullscreen(); },  
 143801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 143874: () => { if (document.fullscreenElement) return 1; },  
 143920: () => { return document.getElementById('canvas').width; },  
 143972: () => { return screen.width; },  
 143997: () => { document.exitFullscreen(); },  
 144024: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 144157: () => { return window.innerWidth; },  
 144183: () => { return window.innerHeight; },  
 144210: () => { if (document.fullscreenElement) return 1; },  
 144256: () => { return document.getElementById('canvas').width; },  
 144308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 144376: () => { if (document.fullscreenElement) return 1; },  
 144422: () => { return document.getElementById('canvas').width; },  
 144474: () => { return screen.width; },  
 144499: () => { return window.innerWidth; },  
 144525: () => { return window.innerHeight; },  
 144552: () => { if (document.fullscreenElement) return 1; },  
 144598: () => { return document.getElementById('canvas').width; },  
 144650: () => { return screen.width; },  
 144675: () => { document.exitFullscreen(); },  
 144702: () => { if (document.fullscreenElement) return 1; },  
 144748: () => { return document.getElementById('canvas').width; },  
 144800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 144868: () => { document.exitFullscreen(); },  
 144895: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 144953: () => { return screen.width; },  
 144978: () => { return screen.height; },  
 145004: () => { return window.screenX; },  
 145031: () => { return window.screenY; },  
 145058: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 145111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 145182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 145239: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 145495: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 145566: () => { if (document.fullscreenElement) return 1; },  
 145612: () => { return window.innerWidth; },  
 145638: () => { return window.innerHeight; },  
 145665: () => { if (document.pointerLockElement) return 1; }
};
